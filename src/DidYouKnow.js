...
const tidbits = [
    ...
    "Of the 92 distinct solutions, if the solutions that differ only by the symmetry operations of rotation and reflection are counted as one, the puzzle has 12 solutions.",
    ...
    "Eight queens if often cited as problem that can be solved with a recursive algorithm, by phrasing the n queens problem inductively in terms of adding a single queen to any solution to the problem of placing n−1 queens on an n×n chessboard.",
